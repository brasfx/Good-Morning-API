...
export default function Search (props){
  ...
  return (
    <div className="w-4/5 md:w-3/5 lg:w-1/2 m-auto">
      ...
      <div className="flex flex-row mx-2 p-2 justify-start border-b border-blue-300">
        <svg
          width="30"
          height="30"
          fill="none"
          className="mr-2 group-hover:text-gray-500 text-blue-600 transition-colors duration-200"
        >
          <path
        ...
        {isSearching ? (
          <svg
            ...
            viewBox="0 0 24 24"
          >
            <title>Insira o nome do local</title>
            <circle
